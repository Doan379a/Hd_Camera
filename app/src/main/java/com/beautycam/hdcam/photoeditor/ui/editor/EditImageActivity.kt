...
import com.beautycam.hdcam.photoeditor.base.base_edit.BaseActivity
import com.beautycam.hdcam.photoeditor.base.extensions.getTagDebug
import com.beautycam.hdcam.photoeditor.databinding.ActivityEditImageBinding
import com.beautycam.hdcam.photoeditor.ui.editor.emoji.EmojiBSFragment
import com.beautycam.hdcam.photoeditor.ui.editor.filters.FilterListener
import com.beautycam.hdcam.photoeditor.ui.editor.filters.FilterViewAdapter
import com.beautycam.hdcam.photoeditor.ui.editor.properties.PropertiesBSFragment
import com.beautycam.hdcam.photoeditor.ui.editor.shape.ShapeBSFragment
import com.beautycam.hdcam.photoeditor.ui.editor.sticker.StickerBSFragment
import com.beautycam.hdcam.photoeditor.ui.editor.text.TextEditorDialogFragment
import com.beautycam.hdcam.photoeditor.ui.editor.tools.EditingToolsAdapter
import com.beautycam.hdcam.photoeditor.ui.editor.tools.ToolType
...
import com.beautycam.hdcam.photoeditor.utils.CameraUtils.getCorrectlyOrientedBitmap
import com.beautycam.hdcam.photoeditor.utils.CameraUtils.resizeBitmapToView
import com.beautycam.hdcam.photoeditor.utils.FileSaveHelper
...
class EditImageActivity : BaseActivity(), OnPhotoEditorListener, View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageUriOrigin = intent.getParcelableExtra("URI_IMAGE")
        ...
        Glide.with(this).load(imageUriOrigin).placeholder(R.drawable.img_loadding).centerCrop().into(binding.photoEditorView.source)
    ...
    private fun shareImage() {
        ...
        lifecycleScope.launch {
            ...
            val uri = FileProvider.getUriForFile(
                ...
                "${this@EditImageActivity.packageName}.provider",
                file
            )
    ...
    private fun saveImage() {
        ...
        if (hasStoragePermission || FileSaveHelper.isSdkHigherThan28()) {
            showLoading("Saving...")
            mSaveFileHelper.createFile(fileName, Foder_Key, object : FileSaveHelper.OnFileCreateResult {
        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                CAMERA_REQUEST -> {
                    ...
                    val photoBitmap = imageUriOrigin?.let { getCorrectlyOrientedBitmap(this, imageUri = it) }
                    binding.photoEditorView.source.setImageBitmap(photoBitmap)
                }
...
//                        binding.txtCurrentTool.setText(R.string.label_text)
                ...
                textEditorDialogFragment.setDismissListenerTextEditor(object : DismissListenerTextEditor {
                    override fun onDismissTextEditor() {
                        mEditingToolsAdapter.resetSelection()
                    }
                })
