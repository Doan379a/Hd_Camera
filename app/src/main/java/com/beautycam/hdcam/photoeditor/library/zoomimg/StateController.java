...
import com.beautycam.hdcam.photoeditor.library.zoomimg.internal.ZoomBounds;
import com.beautycam.hdcam.photoeditor.library.zoomimg.utils.GravityUtils;


/**
 * Helper class that holds reference to {@link com.beautycam.hdcam.photoeditor.library.zoomimg.Settings} object and controls some aspects of view
 * {@link com.beautycam.hdcam.photoeditor.library.zoomimg.State}, such as movement bounds restrictions
 * (see {@link #getMovementArea(com.beautycam.hdcam.photoeditor.library.zoomimg.State, RectF)}) and dynamic min / max zoom levels
 * (see {@link #getMinZoom(com.beautycam.hdcam.photoeditor.library.zoomimg.State)} and {@link #getMaxZoom(com.beautycam.hdcam.photoeditor.library.zoomimg.State)}).
 */
public class StateController {

    // Temporary objects
    private static final com.beautycam.hdcam.photoeditor.library.zoomimg.State tmpState = new com.beautycam.hdcam.photoeditor.library.zoomimg.State();
    ...
    StateController(com.beautycam.hdcam.photoeditor.library.zoomimg.Settings settings) {
     ...
     * when {@link #updateState(com.beautycam.hdcam.photoeditor.library.zoomimg.State)} method will be called.
     *
     * @param state State to be reset
     * @return {@code true} if reset was completed or {@code false} if reset is scheduled for future
     */
    boolean resetState(com.beautycam.hdcam.photoeditor.library.zoomimg.State state) {
        isResetRequired = true;
        return updateState(state);
    }

    /**
     * Updates state (or resets state if reset was scheduled, see {@link #resetState(com.beautycam.hdcam.photoeditor.library.zoomimg.State)}).
     *
     * @param state State to be updated
     * @return {@code true} if state was reset to initial state or {@code false} if state was
     * updated.
     */
    boolean updateState(com.beautycam.hdcam.photoeditor.library.zoomimg.State state) {
        if (isResetRequired) {
    ...
    public void applyZoomPatch(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.State state) {
        if (zoomPatch > 0f) {
     ...
     */
    com.beautycam.hdcam.photoeditor.library.zoomimg.State toggleMinMaxZoom(com.beautycam.hdcam.photoeditor.library.zoomimg.State state, float pivotX, float pivotY) {
        ...
        final com.beautycam.hdcam.photoeditor.library.zoomimg.State end = state.copy();
    ...
    @Nullable
    com.beautycam.hdcam.photoeditor.library.zoomimg.State restrictStateBoundsCopy(com.beautycam.hdcam.photoeditor.library.zoomimg.State state, com.beautycam.hdcam.photoeditor.library.zoomimg.State prevState, float pivotX, float pivotY,
     ...
     */
    boolean restrictStateBounds(com.beautycam.hdcam.photoeditor.library.zoomimg.State state, com.beautycam.hdcam.photoeditor.library.zoomimg.State prevState, float pivotX, float pivotY,
                                boolean allowOverscroll, boolean allowOverzoom, boolean restrictRotation) {
        ...
        if (restrictRotation && settings.isRestrictRotation()) {
            ...
            if (!com.beautycam.hdcam.photoeditor.library.zoomimg.State.equals(rotation, state.getRotation())) {
        ...
        if (!com.beautycam.hdcam.photoeditor.library.zoomimg.State.equals(zoom, state.getZoom())) {
        ...
        if (!com.beautycam.hdcam.photoeditor.library.zoomimg.State.equals(newX, state.getX()) || !com.beautycam.hdcam.photoeditor.library.zoomimg.State.equals(newY, state.getY())) {
     ...
     */
    public float getMinZoom(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.State state) {
     ...
     * Note, that it may be different from {@link com.beautycam.hdcam.photoeditor.library.zoomimg.Settings#getMaxZoom()}.
     */
    @SuppressWarnings({ "unused", "WeakerAccess" }) // Public API
    public float getMaxZoom(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.State state) {
     ...
     * {@link com.beautycam.hdcam.photoeditor.library.zoomimg.Settings#getFitMethod()} is {@link com.beautycam.hdcam.photoeditor.library.zoomimg.Settings.Fit#NONE}).
     */
    public float getFitZoom(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.State state) {
        return zoomBounds.set(state).getFitZoom();
    }

    /**
     * Calculates area in which {@link com.beautycam.hdcam.photoeditor.library.zoomimg.State#getX()} &amp; {@link com.beautycam.hdcam.photoeditor.library.zoomimg.State#getY()} values can change.
