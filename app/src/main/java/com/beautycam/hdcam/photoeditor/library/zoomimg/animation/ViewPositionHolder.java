...
class ViewPositionHolder implements ViewTreeObserver.OnPreDrawListener {
    ...
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition pos = com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition.newInstance();
    ...
    private void update() {
        if (view != null && listener != null && !isPaused) {
            boolean changed = com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition.apply(pos, view);
            if (changed) {
