package com.beautycam.hdcam.photoeditor.ui.editor.text
...
import com.beautycam.hdcam.photoeditor.ui.editor.DismissListenerTextEditor
...
class TextEditorDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mImageClose = view.findViewById(R.id.imgClose)
