package com.beautycam.hdcam.photoeditor.library.zoomimg;
...
import com.beautycam.hdcam.photoeditor.library.zoomimg.Settings;
import com.beautycam.hdcam.photoeditor.library.zoomimg.State;
import com.beautycam.hdcam.photoeditor.library.zoomimg.StateController;
import com.beautycam.hdcam.photoeditor.library.zoomimg.internal.AnimationEngine;
import com.beautycam.hdcam.photoeditor.library.zoomimg.internal.ExitController;
import com.beautycam.hdcam.photoeditor.library.zoomimg.internal.MovementBounds;
import com.beautycam.hdcam.photoeditor.library.zoomimg.internal.detectors.RotationGestureDetector;
import com.beautycam.hdcam.photoeditor.library.zoomimg.internal.detectors.ScaleGestureDetectorFixed;
import com.beautycam.hdcam.photoeditor.library.zoomimg.utils.FloatScroller;
import com.beautycam.hdcam.photoeditor.library.zoomimg.utils.GravityUtils;
import com.beautycam.hdcam.photoeditor.library.zoomimg.utils.MathUtils;

import java.util.ArrayList;
import java.util.List;

/**
 * Handles touch events to update view's position state ({@link com.beautycam.hdcam.photoeditor.library.zoomimg.State}) based on current
 * setup ({@link com.beautycam.hdcam.photoeditor.library.zoomimg.Settings}).<br>
 * Settings can be obtained and altered through {@link #getSettings()}.<br>
 * Note, that some settings are required in order to correctly update state, see {@link com.beautycam.hdcam.photoeditor.library.zoomimg.Settings}.
 * <p>
 ...
 * stuff.
 * <p>
 * State can be animated with {@link #animateStateTo(com.beautycam.hdcam.photoeditor.library.zoomimg.State)} method.<br>
...
public class GestureController implements View.OnTouchListener {
    ...
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.State stateStart = new com.beautycam.hdcam.photoeditor.library.zoomimg.State();
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.State stateEnd = new com.beautycam.hdcam.photoeditor.library.zoomimg.State();

    private final View targetView;
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.Settings settings;
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.State state = new com.beautycam.hdcam.photoeditor.library.zoomimg.State();
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.State prevState = new com.beautycam.hdcam.photoeditor.library.zoomimg.State();
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.StateController stateController;
    ...
    public GestureController(@NonNull View view) {
        ...
        targetView = view;
        settings = new com.beautycam.hdcam.photoeditor.library.zoomimg.Settings();
        stateController = new com.beautycam.hdcam.photoeditor.library.zoomimg.StateController(settings);
     ...
     */
    @NonNull
    public com.beautycam.hdcam.photoeditor.library.zoomimg.Settings getSettings() {
        return settings;
    }
     ...
     */
    @NonNull
    public com.beautycam.hdcam.photoeditor.library.zoomimg.State getState() {
        return state;
    }
     ...
     * @see #animateStateTo(com.beautycam.hdcam.photoeditor.library.zoomimg.State)
     */
    ...
    public boolean animateStateTo(@Nullable com.beautycam.hdcam.photoeditor.library.zoomimg.State endState) {
        return animateStateTo(endState, true);
    }

    private boolean animateStateTo(@Nullable com.beautycam.hdcam.photoeditor.library.zoomimg.State endState, boolean keepInBounds) {
        if (endState == null) {
            return false;
        }
        ...
        com.beautycam.hdcam.photoeditor.library.zoomimg.State endStateRestricted = null;
        if (keepInBounds) {
    ...
    protected boolean onTouchInternal(@NonNull View view, @NonNull MotionEvent event) {
        ...
        if (isRestrictZoomRequested || isRestrictRotationRequested) {
            ...
            if (!exitController.isExitDetected()) {
                com.beautycam.hdcam.photoeditor.library.zoomimg.State restrictedState = stateController.restrictStateBoundsCopy(
    ...
    protected boolean shouldDisallowInterceptTouch(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                final boolean isPannable = com.beautycam.hdcam.photoeditor.library.zoomimg.State.compare(tmpRectF.width(), 0f) > 0
                        || com.beautycam.hdcam.photoeditor.library.zoomimg.State.compare(tmpRectF.height(), 0f) > 0;
    ...
    protected boolean onFlingScroll(int dx, int dy) {
        ...
        return !com.beautycam.hdcam.photoeditor.library.zoomimg.State.equals(prevX, toX) || !com.beautycam.hdcam.photoeditor.library.zoomimg.State.equals(prevY, toY);
    }
    ...
    public interface OnStateChangeListener {
        void onStateChanged(com.beautycam.hdcam.photoeditor.library.zoomimg.State state);

        void onStateReset(com.beautycam.hdcam.photoeditor.library.zoomimg.State oldState, State newState);
    }
