...
import com.beautycam.hdcam.photoeditor.library.zoomimg.transition.internal.FromBaseListener;
import com.beautycam.hdcam.photoeditor.library.zoomimg.transition.tracker.FromTracker;

public class FromRecyclerViewListener<ID> extends com.beautycam.hdcam.photoeditor.library.zoomimg.transition.internal.FromBaseListener<RecyclerView, ID> {
