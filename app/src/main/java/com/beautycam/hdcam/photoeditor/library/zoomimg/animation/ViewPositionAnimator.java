package com.beautycam.hdcam.photoeditor.library.zoomimg.animation;
...
import com.beautycam.hdcam.photoeditor.library.zoomimg.GestureController;
import com.beautycam.hdcam.photoeditor.library.zoomimg.GestureControllerForPager;
...
import com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition;
import com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder;
...
import com.beautycam.hdcam.photoeditor.library.zoomimg.views.GestureImageView;
import com.beautycam.hdcam.photoeditor.library.zoomimg.views.interfaces.ClipBounds;
import com.beautycam.hdcam.photoeditor.library.zoomimg.views.interfaces.ClipView;
import com.beautycam.hdcam.photoeditor.library.zoomimg.views.interfaces.GestureView;
 ...
 * {@link #enter(com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition, boolean)} method. <br>
 ...
 * You can also manually update initial view position using {@link #update(com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition)} method.
 */
public class ViewPositionAnimator {
    ...
    private com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition fromPos;
    private com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition toPos;
    ...
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder fromPosHolder = new com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder();
    private final com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder toPosHolder = new com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder();

    private final com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener fromPositionListener =
            new com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener() {
                @Override
                public void onViewPositionChanged(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition position) {
    ...
    public ViewPositionAnimator(@NonNull GestureView to) {
        ...
        toPosHolder.init(toView, new com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener() {
            @Override
            public void onViewPositionChanged(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition position) {
                if (GestureDebug.isDebugAnimator()) {
     ...
     * {@link #enter(com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition, boolean)} methods instead.</b>
     *
     ...
     * should update to new view using {@link #update(com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition)} method.
     *
     * @param fromPos 'From' view position
     * @param withAnimation Whether to animate entering or immediately jump to entered state
     */
    public void enter(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition fromPos, boolean withAnimation) {
        if (GestureDebug.isDebugAnimator()) {
     ...
     */
    public void update(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition from) {
        if (GestureDebug.isDebugAnimator()) {
    ...
    private void updateInternal(@NonNull com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition from) {
        cleanBeforeUpdateInternal();
        fromPos = from;
        applyCurrentPosition();
    }
     ...
     * or {@link #enter(com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition, boolean)} again in order to continue using animator.
     *
    ...
    private void updateFromState() {
        ...
        if (fromNonePos && settings != null && toPos != null) {
            fromPos = fromPos == null ? com.beautycam.hdcam.photoeditor.library.zoomimg.animation.ViewPosition.newInstance() : fromPos;
