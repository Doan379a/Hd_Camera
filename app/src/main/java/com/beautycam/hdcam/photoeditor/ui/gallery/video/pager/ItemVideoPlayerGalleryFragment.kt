...
class ItemVideoPlayerGalleryFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(videoPath: String): ItemVideoPlayerGalleryFragment {
            Log.d("ItemVideoPlayerFragment", "newInstance() called with path: $videoPath")
            val fragment = ItemVideoPlayerGalleryFragment()
